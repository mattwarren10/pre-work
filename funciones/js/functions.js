...
// namesOne = ["Richie", "Joanie", "Greg", "Marcia", "Bobby"];
// namesTwo = ["Blanka", "Zangief", "Chun Li", "Guile"];
// colors = ["Red", "Blue", "Green"];
// makes = [ "Honda", "Toyota", "Nissan", "Ford", "Chevrolet", "Pontiac", "Oldsmobile" ];
// retail = [ "Aeropostle", "Hollister", "Old Navy", "TJ Maxx", "Ross", "Gucci", "Zales", "Sears" ];

// var sorted_names_one = namesOne.sort(function ( a, b ) {
//     return b.length - a.length
        
// } );

// var sorted_names_two = namesTwo.sort(function ( a, b ) {
//     return b.length - a.length
        
// } );

// var sorted_colors = colors.sort(function ( a, b ) {
//     return b.length - a.length
        
// } );

// var sorted_makes = makes.sort(function ( a, b ) {
//     return b.length - a.length
        
// } );

// var sorted_retail = retail.sort(function ( a, b ) {
//     return b.length - a.length
        
// } );

// console.log( sorted_names_one[0].length === 6 );
// console.log( sorted_names_two[0].length === 7 );
// console.log( sorted_colors[0].length === 5 );
// console.log( sorted_makes[0].length === 10 );
// console.log( sorted_retail[0].length === 10 );
...
// var array_lengths = [];
// array_lengths.push( sorted_names_one[0].length );
// array_lengths.push( sorted_names_two[0].length );
// array_lengths.push( sorted_colors[0].length );
// array_lengths.push( sorted_makes[0].length );
// array_lengths.push( sorted_retail[0].length );

// console.log( "These are the longest lengths of each group: " + array_lengths );
// console.log( calculateAverage( array_lengths ) === 7.6);
...
function arrangeElements( array )
{
	...
	var rearranged_array = array.sort()
